export default function BurnoutFocusPage() {
  return (
    ...
    ←
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#5F675F]">
            When constantly pushing forward has left you feeling exhausted,
            disconnected, or overwhelmed, therapy can help you find a more
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 leading-8 text-[#5F675F]">
              Burnout can happen when prolonged stress, high expectations, and
              constant pressure leave little room for rest or recovery. You
              may still be functioning on the outside while feeling exhausted
              or disconnected internally.
            </p>

            <p className="mt-5 leading-8 text-[#5F675F]">
              Therapy can help you understand the patterns that keep you
              pushing beyond your limits and create healthier ways of working,
              resting, and relating to yourself.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-[#5F675F]">
                  We can explore the patterns behind this experience and find
                  practical ways to create more balance.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="bg-[#E8EDE6] px-6 py-16 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl">
            Making room for rest, boundaries, and a healthier pace.
          </h2>

          <p className="mt-6 max-w-3xl leading-8 text-[#5F675F]">
            We can look at the beliefs and expectations that may be driving
            overwork, perfectionism, or constant self-pressure. Together, we
            can build greater awareness of your needs and develop healthier
            ways to respond to stress.
          </p>

          <p className="mt-5 max-w-3xl leading-8 text-[#5F675F]">
            My approach is warm and collaborative, with attention to both
            emotional patterns and what is happening in your everyday life.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="text-3xl md:text-4xl">
            Support for people who are used to carrying a lot.
          </h2>

          <p className="mt-6 max-w-3xl leading-8 text-[#5F675F]">
            I frequently work with professionals, entrepreneurs, and creatives
            who are experiencing burnout, perfectionism, high expectations, or
            the feeling that they always need to keep going.
          </p>

          <p className="mt-5 max-w-3xl leading-8 text-[#5F675F]">
            Therapy can be a place to slow down, reconnect with yourself, and
            create a way of living and working that feels more sustainable.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl rounded-3xl bg-[#26352F] px-8 py-14 text-center text-white md:px-12">
          <h2 className="text-3xl md:text-4xl">
            You don't have to figure out burnout on your own.
          </h2>

          <p className="mx-auto mt-5 max-w-2xl leading-7 text-[#D5DDD6]">
            If you're ready to explore a healthier and more sustainable pace,
